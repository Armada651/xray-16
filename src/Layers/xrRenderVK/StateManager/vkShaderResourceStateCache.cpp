#include "stdafx.h"
#include "vkShaderResourceStateCache.h"

vkShaderResourceStateCache	SRVSManager;

vkShaderResourceStateCache::vkShaderResourceStateCache()
{
	ResetDeviceState();
}

void vkShaderResourceStateCache::ResetDeviceState()
{
...
void vkShaderResourceStateCache::Apply()
{
	if (m_bUpdatePSViews)
	{
...
void vkShaderResourceStateCache::SetPSResource( u32 uiSlot, ID3DShaderResourceView	*pRes )
{
...
void vkShaderResourceStateCache::SetGSResource( u32 uiSlot, ID3DShaderResourceView	*pRes )
{
...
void vkShaderResourceStateCache::SetVSResource( u32 uiSlot, ID3DShaderResourceView	*pRes )
{
...
#ifdef USE_DX11
void vkShaderResourceStateCache::SetHSResource( u32 uiSlot, ID3DShaderResourceView	*pRes )
{
...
void vkShaderResourceStateCache::SetDSResource( u32 uiSlot, ID3DShaderResourceView	*pRes )
{
	VERIFY(uiSlot<CBackend::mtMaxHullShaderTextures);
...
void vkShaderResourceStateCache::SetCSResource( u32 uiSlot, ID3DShaderResourceView	*pRes )
{
