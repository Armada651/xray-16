#ifndef	vkShaderResourceStateCache_included
#define	vkShaderResourceStateCache_included
#pragma once

class vkShaderResourceStateCache
{
public:
	vkShaderResourceStateCache();
...
extern	vkShaderResourceStateCache	SRVSManager;

#endif	//	vkShaderResourceStateCache_included