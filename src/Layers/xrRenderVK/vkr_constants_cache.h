#ifndef vkr_constants_cacheH
#define vkr_constants_cacheH
#pragma once
...
private:
    ...
    {
        vkConstantBuffer& Buffer = GetCBuffer(C, BType);
        Buffer.set(C, L, A);
    }
    ...
    vkConstantBuffer& GetCBuffer(R_constant* C, BufferType BType);
};
#endif //	vkr_constants_cacheH
